...
public class ErrorHandler {
    ...
    @ExceptionHandler({FilmNotFoundException.class, UserNotFoundException.class, MpaCategoryNotFoundException.class, GenreNotFoundException.class, DirectorNotFoundException.class})
